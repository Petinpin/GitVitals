  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ marginTop: 16, lineHeight: 1.6 }}>
        ...
        <div>
          <b>Vitals:</b> HR: {safe(r.heartRate)} | RR: {safe(r.respRate)} | Temp: {safe(r.tempF)}°F | BP:{' '}
        ...
        <div>
          <b>Instructor notes:</b> {r.instructorNotes ?? '-'}
        </div>
      </div>

      <div style={{ marginTop: 18 }}>
        <Link href={`/student/${studentId}/submission`} style={{ textDecoration: 'underline' }}>
          Back to submissions
        </Link>
      </div>
    </div>
